...
create_library_set -name default_emulate_libset_max -timing [list /cadence/FOUNDRY/digital/90nm/dig/lib/slow.lib]
create_library_set -name default_emulate_libset_min -timing [list /cadence/FOUNDRY/digital/90nm/dig/lib/slow.lib]
