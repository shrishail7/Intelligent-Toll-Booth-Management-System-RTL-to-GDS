...
#  Created on Mon Nov 10 17:50:46 2025                
#                                                     
#######################################################
...
report_power -rail_analysis_format VS -outfile placement_reports/power.rpt
report_area -detail > placement_reports/area.rpt
reportGateCount -level 5 -limit 100 > placement_reports/gate_count.rpt
...
group_path -name in2reg_tmp.21512 -from {0x1456 0x1459} -to 0x145a -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.21512 -from {0x145d 0x1460} -to 0x1461 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.21512 -from 0x1463 -to 0x1464
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.21512 -from 0x1467 -to 0x1468
setPathGroupOptions reg2reg_tmp.21512 -effortLevel high
reset_path_group -name reg2out_tmp.21512
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.21512
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.21512
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.21512
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.21512 -from {0x1472 0x1475} -to 0x1476 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.21512 -from {0x1479 0x147c} -to 0x147d -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.21512 -from 0x147f -to 0x1480
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.21512 -from 0x1483 -to 0x1484
setPathGroupOptions reg2reg_tmp.21512 -effortLevel high
reset_path_group -name reg2out_tmp.21512
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.21512
...
verify_drc > placement_reports/report/placement_DRC_vio.rpt
verifyConnectivity > placement_reports/report/post_detailedRoute_verifyConnectivity.rpt
reportRoute > placement_reports/report/postDetailRoute_reportRoute.rpt
reportWire > placement_reports/report/postDetailRoute_reportWire.rpt
summaryReport -outdir placement_reports/report/summaryReport
...
reportGateCount -level 5 -limit 100 -outfile placement_reports/gates/gate_count.rpt
...
set_ccopt_property target_max_trans_sdc -delay_corner delay1 -early -clock_tree clk 0.600
set_ccopt_property target_max_trans_sdc -delay_corner delay1 -late -clock_tree clk 0.600
...
fit
zoomBox -13.95250 1.54850 127.10000 96.99350
zoomBox 29.00400 19.62850 102.63500 69.45200
zoomBox 49.78500 27.49250 95.00400 58.09050
zoomBox 58.96250 30.97700 91.63400 53.08450
zoomBox 68.18350 34.49400 88.24800 48.07100
zoomBox 70.38450 35.33350 87.43950 46.87400
zoomBox 68.18300 34.49400 88.24800 48.07100
zoomBox 64.66050 32.71600 88.26650 48.68950
zoomBox 55.64050 28.16450 88.31400 50.27350
zoomBox 35.21700 17.85950 88.42100 53.86050
zoomBox 1.96050 1.07900 88.59550 59.70150
zoomBox -52.19250 -26.24650 88.88000 69.21200
