...
#  Created on Mon Nov 10 20:26:39 2025                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.2104 -from {0x1457 0x145a} -to 0x145b -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.2104 -from {0x145e 0x1461} -to 0x1462 -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.2104 -from 0x1464 -to 0x1465
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.2104 -from 0x1468 -to 0x1469
setPathGroupOptions reg2reg_tmp.2104 -effortLevel high
reset_path_group -name reg2out_tmp.2104
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.2104
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.2104
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.2104
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.2104 -from {0x1473 0x1476} -to 0x1477 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.2104 -from {0x147a 0x147d} -to 0x147e -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.2104 -from 0x1480 -to 0x1481
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.2104 -from 0x1484 -to 0x1485
setPathGroupOptions reg2reg_tmp.2104 -effortLevel high
reset_path_group -name reg2out_tmp.2104
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.2104
