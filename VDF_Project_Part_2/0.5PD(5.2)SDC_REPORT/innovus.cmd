...
#  Created on Sun Nov  9 06:04:15 2025                
#                                                     
#######################################################
...
group_path -name in2reg_tmp.72185 -from {0x1454 0x1457} -to 0x1458 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.72185 -from {0x145b 0x145e} -to 0x145f -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.72185 -from 0x1461 -to 0x1462
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.72185 -from 0x1465 -to 0x1466
setPathGroupOptions reg2reg_tmp.72185 -effortLevel high
reset_path_group -name reg2out_tmp.72185
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.72185
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2out_tmp.72185
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name reg2reg_tmp.72185
set_global _is_ipo_interactive_path_groups 0
...
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2reg_tmp.72185 -from {0x1470 0x1473} -to 0x1474 -ignore_source_of_trigger_arc
getOptMode -allowPreCTSClkSrcPaths -quiet
set_global _is_ipo_interactive_path_groups 1
group_path -name in2out_tmp.72185 -from {0x1477 0x147a} -to 0x147b -ignore_source_of_trigger_arc
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2reg_tmp.72185 -from 0x147d -to 0x147e
set_global _is_ipo_interactive_path_groups 1
group_path -name reg2out_tmp.72185 -from 0x1481 -to 0x1482
setPathGroupOptions reg2reg_tmp.72185 -effortLevel high
reset_path_group -name reg2out_tmp.72185
set_global _is_ipo_interactive_path_groups 0
reset_path_group -name in2reg_tmp.72185
